...
USAGE = ("python get.py validate              every retailer file in data/\n"
         "python get.py validate kith agjeans   named retailers only")

# get writes <retailer>-<stamp>.json. The stamp carries no hyphen, so the
...
def main(argv: list[str] | None = None) -> None:
    parser = argparse.ArgumentParser(prog="python get.py validate",
