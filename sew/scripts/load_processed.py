...
def load() -> None:
    ...
    try:
        with connection.cursor() as cursor:
            # Before anything is truncated: a COPY INTO from an empty stage
            # loads nothing and reports success, which would leave every table
            # emptied and unfilled.
            preflight.require_uploaded_parquet(cursor, database, schema)
